...
class AssistantReferralsScreen extends ConsumerStatefulWidget {
  const AssistantReferralsScreen({super.key});

  @override
  ConsumerState<AssistantReferralsScreen> createState() =>
      _AssistantReferralsScreenState();
}

class _AssistantReferralsScreenState
    extends ConsumerState<AssistantReferralsScreen> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          currentIndex: 1,
          onTap: (i) {
            if (i == 0) context.go('/assistant/dashboard');
